...
import '../../Utils/bookingQrCard.dart';
...
class BookingPage extends StatefulWidget {
  ...
  @override
  State<BookingPage> createState() => _QrPageState();
}

class _QrPageState extends State<BookingPage> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                      ...
                      child: bookingQrbuildCard(formcontroller, index));
                },
              ),
            ),
          ],
